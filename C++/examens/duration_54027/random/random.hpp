 ...
 * graine plantée avec g54027::randomize. Pour s'en convaincre,
 * exécuter g54027::random_value(1, 100000) par des instances
 ...
 * aléatoires partagé par g54027::urng() dans un état aléatoire.
 * Elle est issue de Random Number Generation in C++11
 * ([WG21 N3551]
 * (http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2013/n3551.pdf)),
 * par Walter E. Brown.
 ...
 * g54027::random_value<T> produisant des entiers aléatoires, les
